...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", default=128, type=int, help="training batch size *PER WORKER*")
    parser.add_argument("--base", default="google-bert/bert-base-cased", type=str, help="base model configuration (and tokenizer) to use")
