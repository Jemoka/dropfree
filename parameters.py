...
# intervals
parser.add_argument("--report_interval", default=16, type=int, help="save to wandb every this many steps")
parser.add_argument("--checkpoint_interval", default=4096, type=int, help="checkpoint every this many steps")
parser.add_argument("--validation_interval", default=4096, type=int, help="validate every this many steps")
